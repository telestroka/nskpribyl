...
class Site {
	...
	private function __construct()	{
		...
		if (isset($this->config['db'])) {
			$db = ($_SERVER['SERVER_ADDR'] == '127.0.0.1') ? $this->config['debug_db'] : $this->config['db'];
			$this->db = new PDO(
		...
		if ( $_SERVER['SERVER_ADDR'] == '127.0.0.1') $_SESSION['current_user'] = array ('id' => -1, 'title' => 'Разработчик', 'access' => '5');
